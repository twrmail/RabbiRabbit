  ...
  return (
    <div>
      ...
      <style>{`
        ...
        .study-output h1 { font-family: 'Cormorant Garamond', serif; font-size: 30px; font-weight: 700; color: var(--navy); margin: 0 0 6px; line-height: 1.2; }
        .study-output h2 { font-family: 'Cormorant Garamond', serif; font-size: 22px; font-weight: 600; color: var(--navy); margin: 28px 0 10px; }
        .study-output h3 { font-family: 'Inter', sans-serif; font-size: 10px; font-weight: 600; color: var(--ink-light); text-transform: uppercase; letter-spacing: 0.12em; margin: 22px 0 6px; }
        ...
        .trail-head { margin: 24px 0 10px; padding: 10px 16px; border-left: 4px solid var(--gold); background: var(--gold-pale); font-family: 'Inter', sans-serif; font-size: 13px; font-weight: 600; color: var(--gold); border-radius: 0 6px 6px 0; }
        ...
        @media print { header, footer, .study-output ~ div { display: none; } .study-output { border: none; box-shadow: none; padding: 0; } }
      `}</style>
    </div>
  )
}
